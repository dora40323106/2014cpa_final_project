...
class Application(object):
    ...
    def __init__(self):
        ...
        self.name = '楊宗祐'
        # 你的學號
        self.number = '40323148'
        # 你的班級
        self.classes = '機械設計工程系'
        # 你的 github repository url
        self.github_repo_url = 'https://github.com/40323148/exa2-1.git'
        # 你的 bitbucket repository url
        self.bitbucket_repo_url = ''
        # 你的 openshift app
        self.openshift_url = 'https://exa2-40323148.rhcloud.com'
        # 你的自評
        self.evaluation = [('Project 7', 85), ('Project 8', 85), ('Project 9', 85)]
        # 你的照片 url
        self.photo_url = 'https://lh4.googleusercontent.com/FnGdeZ0nYaBKIpqh0mvMMXFbcJ-T9k8v3_UcPScPaM6lfcSTmJTxv258eAF2LFcmLkEMdg=w200-h150-p-nu'
        # 這裡是心得
        self.my_remark = """
        最近對程式兩個字有莫名恐懼，或許是因為學得越多越發學自己會的很少，從最初想自己開發 一種程式語言跟開發環境到現在學了一學期才終於對python有一絲了解，心中始終有一個疑問:為什麼會這麼複雜！當然我一開始就知道會有這個問題了，畢竟程式語言本來就不是以東方人的母語跟思維方式設計的，所以發展落後的我們也只能順應時勢設法學習，雖然過程痛苦但如果不撐過這段痛苦就會繼續落後下去，這也是我為何想自行開發程式語言的原因，畢竟拼音語系的種種不合理對於使用形意文字的我們而言實乃一大問題，再者中文字已被各國語言及文字學者認為是最為先進最具邏輯性文法限制最少最能直覺判定的文字(語言)了，是故吾人就想做為自然語言中最高級的語言如果可以程式化勢必為程式語言的世界帶來一股新流與躍進，既可為數十年來一直被認為是落後象徵著中文平反，又能替廣大的形意字使用者減少學習時的負擔，當然，此一舉數得的想法說來簡單做來難，畢竟拼音語系在程式中已行之有年，而中文卻正要起步，但我始終認為只要願意開始一切皆雖晚不遲。
        """
