...
class Application(object):
    ...
    def __init__(self):
    	#你的名子
        self.name = 'Xin-Yu Zeng'
        # 你的學號
        self.number = '40323106'
        # 你的班級
        self.classes = 'NFU-MED-A'
        # 你的 github repository url
        self.github_repo_url = 'https://github.com/dora40323106/final-porject.git'
        # 你的 openshift app
        self.openshift_url = 'http://cat-40323106.rhcloud.com/'
        # 你的自評
        ...
        self.my_remark = """
        這個學期學了不少東西</br>
        從一開始熟悉python,看影片去了解電腦怎麼運作</br>
        用openshift.github.bitbuket.Leo去管理一些資料</br>
        做了期末作業去回想學過的這些東西都像是前幾個禮拜才剛開學一樣</br>
        在這期間也學會老師教學時使用的app</br>
        在其他比較熟悉的科目也會使用錄製螢幕畫面來拍影片教同學畫圖</br>
        還懂了一點點超文件所用的語法</br>
        雖然學的過程很不懂</br>
        有時候還會出錯</br>
        但是做完之後都覺得一切都很值得</br>
    ...
    def remark(self):
        ...
        return self.generate_headline_page("I Want to say...", self.my_remark)
