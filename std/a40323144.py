...
class Application(object):
    #@+others
    #@+node:lee.20141221203113.62: *45* def __init__
    def __init__(self):
        self.name = '曾炫期'
        self.number = '40323144'

        self.classes = '四機械設計一甲'
        self.github_repo_url = 'https://github.com/mdeta/2014cp'

        self.evaluation = [('Project1 ', 75), ('Project2 ', 75), ('Project3 ', 75)]
        self.photo_url = 'https://scontent-a-pao.xx.fbcdn.net/hphotos-prn2/v/t1.0-9/62486_508619579244851_190751363_n.jpg?oh=080cf7ceb51f572b201d04f69805297a&oe=54E628CC'
    def get_nav(self):
        """
        取得 nav link
        """
        ...
        return anchors
    #@+node:lee.20141215164031.98: *45* def index
    @cherrypy.expose
    def index(self):
        """
        個人首頁
