...
class Application(object):
    ...
    def __init__(self):
        ...
        self.github_repo_url = 'https://github.com/40323107'
        # 你的 openshift app
        self.openshift_url = 'http://0105-40323105.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 60), ('Project 8', 60), ('Project 9', 60)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/2KAyB8NLZZoWtiFT'
        # 這裡是心得
        self.my_remark = """
        從一開始的字串、第七週練習、九九乘法表，到使用github，最後再連接到openshift，其實只聽得懂前面一點點，
        但後來還是慢慢理解， 雖然有時還是搞不清楚自己 push 到哪裡去，之後想同步又是一門學問，
        如果要使 github 和 openshift 同步的話，要先使用git remote add openshit，之後再用git push opeshift master
        ，而且如果有人比你先push的話，又必須pull下來，不斷的重複這動作。感覺很麻煩的說。
        總而言之，這門課讓我獲益良多，我也從中學習到許多網路知識，再來就要看我如何運用了
        實際上，要製作一個屬於自己的網頁真的不簡單呀！有很多事情必須要解決呢！
        最後，感謝教授的指導、感謝助教的指導、感謝同學的指導，因為有你們的幫助與教導，我才能順利完成這次的
        作業，雖然做的不好，但真的很感謝你們。
        """
