...
class Application(object):
    ...
    def __init__(self):
        ...
        # 你的 openshift app
        self.openshift_url = 'http://zj2-40323109.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 80), ('Project 8', 80), ('Project 9', 80)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/RTLgZeYCqAxcb3Qz'
        # 這裡是心得
        self.my_remark = """
        計算機程式這一門課對我來說很新鮮，有些不太好學，剛開始還被複雜的英文加數字組合，搞得一個頭兩個大，經過這學期的課程後，學了很多沒接觸過的東西，
        比如說OpenShift和GitHub的應用、Python寫程式之類的，過程中遇到較困難的疑問，和同學一起看上課影片討論，加上每節上課的練習，問題一一解決，
        頗有成就感的。
        """
