...
class Application(object):
    ...
    def __init__(self):
        ...
        # 你的 openshift app
        self.openshift_url = 'http://cpa-nfutaiwan.rhcloud.com/40323118/'
        # 你的自評
        self.evaluation = [('Project 7', 70), ('Project 8', 75), ('Project 9', 80)]
        # 你的照片 url
        self.photo_url = 'https://fbcdn-sphotos-d-a.akamaihd.net/hphotos-ak-xpa1/v/t1.0-9/10270644_876723102359519_5163386798623596562_n.jpg?oh=9955165041daba577abf38a54a25e13e&oe=553743E6&__gda__=1433219422_d1ab2a20a2789dee7f532018ad0c3ac6'
        # 這裡是心得
        self.my_remark = """
        雖然說我還是覺得這門課不適我的菜，但我也進我全力過了，希望老師大發慈悲給我一次機會
        """
