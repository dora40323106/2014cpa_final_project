...
class Application(object):
    ...
    def __init__(self):
        ...
        self.github_repo_url = 'https://github.com/40323102/2014_cpa_final_project-40323102'
        # 你的 openshift app
        self.openshift_url = 'http://finalproject40323102-sandy40323102.rhcloud.com/'
        # 你的自評
        self.evaluation = [('猜數字', 80), ('九九乘法表', 80), ('期末自評分數', 80)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/ZrqiqOH9qxpEfkPj'
        # 這裡是心得
        self.my_remark = """這門課,是在求學階段以來,第一次學習程式語言,
所以在一開始的時候,完全沒有概念,就只能勉強去試試看。</br>一直到了後來,上了越多次的課,同學也教過很多次,甚至還有影片可以看,
就漸漸知道自己在做什麼,要做什麼,該打哪個指令,每個網站的功能。</br>而每次的作業都要試好幾次,也不是一次就成功,
所以中間的過程藉會重複好幾次,自然就熟悉步驟了。</br>
到了現在,對這些程式不會再那麼陌生了!
        </br>
