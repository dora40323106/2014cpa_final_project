...
class Application(object):
    ...
    def __init__(self):
        ...
        # 你的 openshift app
        self.openshift_url = 'http://pythonw12-40323133.rhcloud.com/''http://pythonw11-40323133.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 80), ('Project 8', 80), ('Project 9', 80)]
        # 你的照片 url
        self.photo_url = 'https://fbcdn-sphotos-h-a.akamaihd.net/hphotos-ak-xpa1/v/t1.0-9/10354900_577381035706449_745481432372504952_n.jpg?oh=840e0779ae920a5e8e21f0b1c71a3bf0&oe=54F3AEDE&__gda__=1424476131_874c128407d3267ccfce0b364b9b4b56'
        # 這裡是心得
        self.my_remark = """
        我覺得計算機程式這門課對我來說不太好學，但經過這好幾週的課後我還是學會了一些東西，像使用OpenShift和GitHub做版次管理，
        可以用幾個簡單的指令和同學合作寫程式，雖然最後的期末報告我也只會修改範例，但是能自己弄完也是有一些成就感。
        """
