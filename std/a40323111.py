...
class Application(object):
    ...
    def __init__(self):
        ...
        # 你的 openshift app
        self.openshift_url = 'http://guess-40323111.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 75), ('Project 8', 75), ('Project 9', 75)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/auDjYGbuCueEThFr'
        # 這裡是心得
        self.my_remark = """
        感謝老師和同學的幫忙，雖然努力學習但還是需要同學指導，才完成期末報告。
        """
