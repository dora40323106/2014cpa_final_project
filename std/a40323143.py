...
class Application(object):
    ...
    def __init__(self):
        ...
        self.classes = '四設計一甲'
        self.github_repo_url = 'https://scontent-b-hkg.xx.fbcdn.net/hphotos-xpf1/v/t1.0-9/s720x720/10417817_647198035375147_1796491072557334369_n.jpg?oh=d66709107a40b2ee967ae2a6fb08d9d8&oe=54B7DEFA'
