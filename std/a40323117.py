...
class Application(object):
    ...
    def __init__(self):
        ...
        # 你的 openshift app
        self.openshift_url = 'http://pythonguess-40323117.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 75), ('Project 8', 75), ('Project 9', 80)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/wYG3RuHAR4RZ8cXM'
        # 這裡是心得
        self.my_remark = """
        剛開始時我覺得這門課很複雜，直到現在還是覺得很複雜，但多虧老師和祐生的教導才能做出來。
        """
